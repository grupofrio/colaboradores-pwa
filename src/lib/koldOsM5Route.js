// ─── KOLD OS · M5 — routing directo a Odoo ───────────────────────────────────
// PROHIBIDO el fallback n8n para estas rutas (viven SOLO en Odoo,
// gf_kold_os_m5). Espejo del backend GrupoVeniu/GrupoFrio PR #208:
// si el contrato cambia paths o campos, este archivo y m5/contract.js son los
// únicos puntos de ajuste del wiring.
// Molde: koldOsM2Route.js (patrón mergeado en main).

export const KOLD_OS_M5_LATEST_PATH = '/pwa-kold-os/m5/latest'
export const KOLD_OS_M5_FINDINGS_PATH = '/pwa-kold-os/m5/findings'
export const KOLD_OS_M5_RUNS_PATH = '/pwa-kold-os/m5/runs'
...
export const KOLD_OS_M5_FINDINGS_PARAMS = Object.freeze([
  'run_id',
...
export function isKoldOsM5Path(cleanPath) {
  return cleanPath === KOLD_OS_M5_LATEST_PATH
    || cleanPath === KOLD_OS_M5_FINDINGS_PATH
    || cleanPath === KOLD_OS_M5_RUNS_PATH
}

// Filtra un query (URLSearchParams u objeto plano) a SOLO la allowlist.
export function filterKoldOsM5Params(query) {
  const out = {}

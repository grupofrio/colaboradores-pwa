...
//
// Aquí SOLO se sanea forma (string corto en minúsculas). La AUTORIZACIÓN sigue
// siendo del gate: readAuthoritativeTowerStatus aplica la allowlist fail-closed
// (esta capa NO amplía la allowlist ni inventa valores) y, en el endpoint M1,
// Odoo revalida el rol server-side con el token de empleado — el valor guardado
// en el cliente es UX, nunca autorización.

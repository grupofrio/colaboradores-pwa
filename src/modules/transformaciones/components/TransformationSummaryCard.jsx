...
export default function TransformationSummaryCard({ summary, sw, tokens = DARK_TOKENS }) {
  ...
  return (
    <div style={{
      ...
      background: summary.irregularity_flag ? TOKENS.colors.warningSoft : TOKENS.colors.successSoft,
      ...
      <div style={{ marginTop: 8 }}>
        <TransformationStateBadges item={summary} tokens={TOKENS} />
      </div>

...
// Accesos de respaldo del rol: brief de gerencia, forecast (con el fix de campos
// de Fase 1), alertas completas, y las superficies universales (encuestas,
// premios, perfil). Asistencias se ofrece siempre; la autoridad real es la
// allowlist del endpoint (quien no esté, recibe 403).

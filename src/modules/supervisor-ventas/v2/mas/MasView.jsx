...
//  · Nota rápida: aún usa /pwa-supv/notes + flujo de voz sin auditar en V2.
//  · Bajas (§3): backend no localizado/auditado en estos repos.
//  · Planeación — Pronóstico y Agregar cliente (pantallas parciales).
// Tareas / Notas: migradas al contrato V2 canónico y enlazadas en Coaching.
// Rutas excluidas restantes usan V2ExcludedRoute en App.jsx.
...
const GROUPS = [
  ...
  },
  {
    title: 'Coaching',
    tiles: [
      { label: 'Tareas', desc: 'Asignar y dar seguimiento al equipo', route: '/equipo/tareas' },

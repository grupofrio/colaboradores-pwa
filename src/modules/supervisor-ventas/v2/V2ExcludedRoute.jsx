...
//
// RED Codex P1 (Fase 2): estas pantallas legacy ESCRIBEN por endpoints inseguros
// (auth="api_key" + sudo, sin rol/scope). El módulo Equipo se amplió al gerente
// (lectura), pero el gerente NO debe montar estas superficies de escritura por
// deep-link cuando el flag del supervisor está OFF. La rama legacy se reserva al
// supervisor REAL (job_key supervisor_ventas): cualquier otro rol —gerente
// incluido— cae SIEMPRE al estado seguro, sin importar el flag del supervisor.

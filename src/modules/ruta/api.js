...
export async function getMyRoutePlan(employeeId, criteria = {}) {
  const plan = await api('GET', buildMyRoutePlanPath(employeeId, criteria))
  return normalizeRoutePlanResponse(plan)
}

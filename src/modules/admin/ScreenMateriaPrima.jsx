// ─── ScreenMateriaPrima — entrada al módulo Materia Prima V2 ────────────────
// Desktop (≥1024px): AdminShell + AdminMateriaPrimaForm consumiendo los
// wrappers /pwa-admin/materia-prima/* sobre stock/picking/transformation.
...
export default function ScreenMateriaPrima() {
  ...
  return (
    <AdminProvider>
      <AdminShell activeBlock="mp" title="Materia prima">
        <AdminMateriaPrimaForm />
      </AdminShell>
    </AdminProvider>
  )
}
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '0 16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, paddingTop: 20, paddingBottom: 12 }}>
          ...
          <span style={{ fontSize: 18, fontWeight: 700, color: TOKENS.colors.textSoft }}>Materia prima</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, color: TOKENS.colors.textSoft, margin: '0 0 8px' }}>
              El visor de materia prima está diseñado para pantallas grandes.
            </p>

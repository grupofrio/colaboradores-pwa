...
export default function App() {
  ...
  useEffect(() => {
    ...
    const isProductionLightRole = ['operador_rolito', 'operador_barra', 'auxiliar_produccion', 'supervisor_produccion', 'almacenista_entregas', 'auxiliar_admin', 'gerente_sucursal', 'direccion_general', 'jefe_ruta', 'auxiliar_ruta'].includes(session?.role)

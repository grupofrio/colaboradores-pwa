...
test('App.jsx has a dedicated Ventas Iguala guard with auth and configured-access redirects', () => {
  ...
  assert.match(guard, /readConfiguredVentasIgualaAccessForSession\(session\)\.level !== 'iguala_sales'/)

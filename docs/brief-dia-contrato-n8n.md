...
| Producción — "Mi Brief de planta" | `/api-n8n/brief-produccion` | `supervisor_produccion` (Miguel, emp 577) + `direccion_general` | `supervisor_produccion` + `direccion_general` | `?d=YYYY-MM-DD` |
